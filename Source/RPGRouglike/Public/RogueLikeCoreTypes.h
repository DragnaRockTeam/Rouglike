...
enum class EAttackEffectChance : uint8
{
    ...
    Lighing UMETA(DisplayName = "Lighing"),
...
static const TMap<EAttackEffectChance, FName> EffectsNames = {
    ...
    {EAttackEffectChance::Lighing, FName("_Lighing")},    //
...
static const TMap<EAttackEffectChance, TSubclassOf<UDamageType>> EffectsDamageTypes = {
    {EAttackEffectChance::Lighing, UDamageType::StaticClass()},  //
    {EAttackEffectChance::Fire, UDamageType::StaticClass()},     //
...
USTRUCT(BlueprintType) struct FPassiveCharacteristic : public FTableRowBase
{
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Characteristic")
    TMap<EAttackEffect, float> EffectsDamages;
...
static bool CheckPassiveCharacteristic(FPassiveCharacteristic CharacteristicToCheck) noexcept
{
    UE_LOG(LogCharacteristic, All,
        ...
        CharacteristicToCheck.EffectChances[EAttackEffectChance::Lighing],                      //
        ...
        CharacteristicToCheck.EffectsDamages[EAttackEffect::Lighing],                           //
    ...
    return CharacteristicToCheck.MaxHealth > 0.0f                                                         //
           ...
           && IsValueBetween(CharacteristicToCheck.EffectChances[EAttackEffectChance::Lighing], 0, 100)   //
           ...
           && CharacteristicToCheck.EffectsDamages[EAttackEffect::Lighing] >= 0.0f                        //
